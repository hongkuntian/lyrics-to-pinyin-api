...
export type ReviewProgress = {
  review_enabled: boolean; review_publication_enabled: boolean; review_daily_micros: string; review_monthly_micros: string; review_max_daily: number;
  review_daily: string; review_monthly: string;
  pending: number; processing: number; assessed: number; blocked: number; kept: number; deferred: number; published: number;
  last_run_at: string | null; last_outcome: string | null;
  stage: string | null; batch_state: string | null; provider_status: string | null; error_code: string | null;
};
export type ReviewAssessment = {
  ...
  comparison: string | null; comparison_summary: string | null; disposition: string | null; published_revision_id: string | null; closed_at: string | null;
};
