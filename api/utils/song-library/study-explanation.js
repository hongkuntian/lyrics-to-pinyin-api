...
export const explanationKey=(doc,translation,selection,language='en')=>digest({documentID:doc.id,sourceHash:doc.sourceHash,translationID:translation?.id??null,selection,target:canonicalTarget(language),recipe:explanationRecipe(selection,language)});
