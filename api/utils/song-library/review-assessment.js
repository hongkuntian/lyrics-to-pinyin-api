...
export function assessmentBody(doc,content,reports) {
  ...
  return {...original,instructions:`Assess an existing whole-song English translation. Read the entire source and current translation before deciding whether a report identifies a real defect.
Track voices, emotional movement, concrete imagery and changes between refrains. Preserve who acts and who is affected, questions, negation, conditional versus promised action and time relations. Leave unstated people and objects open where the source does. Singer and narrator are not automatically the same person. Inherit subjects and speakers across adjacent occurrences unless the source changes them.
Preserve the scope of each clause: speaking for someone, committing to something, allowing it and performing it are distinct. Attach on-behalf-of relations to the predicate they modify. Preserve a metaphor's operative action and result, including incompleteness. Do not substitute a smoother image that changes the physical outcome or erase a meaningful verb.
Judge English as a connected poem with natural syntax and a coherent voice, allowing sentences to flow across entries. Fidelity constrains style. Do not force rhyme, embellish images or flatten emotional restraint. Similar refrains may change agents, endings or meaning. Supplied lexical senses are alternatives, not proof of the intended reading. Source-owned speaker metadata helps interpretation but must never be generated as a lyric prefix.
