...
async function run(apis,body={},deps={}) {
  ...
  await createMusicRomanizeHandler({redis:null,getAvailableAPIsFn:()=>apis,getProcessorFn:()=>processor,providerTimeoutMs:20,logger:{error(){},log(){}},...deps})(createMockReq({body:{artist:'周杰伦',title:'晴天',duration:269,language:'zh',...body}}),res);
  return res;
}
